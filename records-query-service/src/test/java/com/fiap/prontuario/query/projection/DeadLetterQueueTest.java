...
/**
 * Testa a resiliencia do consumer (issue #14): um evento que nunca consegue
 * ser desserializado/projetado (aqui, um tipo de evento desconhecido)
 * esgota os retries do circuit breaker e acaba na DLQ
 * {@code patient-record-events-dlq}, preservando o payload original e o
 * motivo da falha, sem travar o consumo do topico principal.
 */
@QuarkusTest
